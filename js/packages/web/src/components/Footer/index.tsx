      ...
      <div className="f-container">
        <div className="footer-info">
          <div className="footer-community">
            ...
            <div className="footer-link">
              <p>
                A next-generation NFT Marketplace that enables the utility of
                the world’s most sought-after digital assets.
              </p>
        ...
        <div className="footer-foot">
          <div className="small-body footer-link">
            {/* 2021 {LABELS.STORE_NAME} LLC, All rights reserved */}© 2022{' '}
            {LABELS.STORE_NAME} LLC, All Rights Reserved.
          ...
          <div className="footer-social-icons">
            <a href="https://twitter.com/starlight_meta" target="_blank" rel="noreferrer">
              <i className="fab fa-twitter"></i>
            </a>
            <a href="https://t.me/starlightmeta" target="_blank" rel="noreferrer">
              <i className="fab fa-telegram-plane"></i>
            </a>
            <a href="https://www.instagram.com/starlightmeta/" target="_blank" rel="noreferrer">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <a href="https://discord.com/invite/h3pWz4fY72" target="_blank" rel="noreferrer">
              <i className="fab fa-discord"></i>
            </a>
            <a href="https://www.reddit.com/r/starlightmeta/" target="_blank" rel="noreferrer">
